...
Finally, I include dummy variables for whether a block group intersects with what I call a PMD (named after Chicago's Plannined Manufacturing Districts) policy. PMD shapefiles were collected from individual city websites, given upon request by the city, or, in the case of New York City, manually created from the affected parcels.
...
While manufacturing is often the poster child for urban industrial employment and development, the availability of industrial land serves mulitple kinds of industrial users allowing analysts to measure the geography of production in multiple ways. For this study, I tracked both manufacturing employment (CNS05 in the LEHD corresponding to the NAICS industry sectors 31-33) and a broader "industrial" employment category that is the sum of agricultural, mining, utilities, manufactucturing, wholesale trade, and transportation and warehousing eployment. 
...
![Figure 1](images/mfg_index_line_facet.png)
...
![Figure 2: Most Large US Cities had at least 25,000 manufacturing jobs](images/mfg_tot_emp_2015_lollipop.png)

![Figure 3:Wichita and San Jose lead large cities in the percentage share of jobs in manufacturing](images/mfg_share_2015_lollipop.png)
