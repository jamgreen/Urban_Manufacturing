...
p_load(RPostgreSQL, ggthemes, here, ggplot2, sf, kableExtra, stargazer, dplyr, extrafont, hrbrthemes,viridis)
...
acs_tab <- tbl(con, "propensity_blkgrp")
acs_tab <- collect(acs_tab)

city_lehd <- city_lehd %>% left_join(acs_tab, by = c("bg_fips" = "geoid"))
