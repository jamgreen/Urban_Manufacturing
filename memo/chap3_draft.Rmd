...
Table 6 shows the results of the propensity score-weighted models. Results in divided into two main groups, the first two models estimate the impact of the PMD designation on industry and manufacturing change for the full sample of block groups while models three and four estimate the PMD impact on the smaller restricted sample to block groups with at least four industrial jobs. Overall, the average treatment effect of PMD designation is both significant and positive for industrial jobs and non-significant and marginally positive for manufacturing jobs under both the full and restricted samples. For industrial jobs in the full sample, the average treatment effect is 199.7 jobs meaning that if every block group in the sample were shifted to PMD designation they would have gained nearly 200 more jobs on average. The same pattern holds in the restricted sample with PMD designation having a non-significant effect on manufacturing job change but a positive and significant change for industrial jobs. For the restricted sample the average treatment effect of PMD designation is 189.2 jobs. The slightly lower estimated effect for the restricted sample is
