...
Due to the policy goal of protecting industrial users, manufacturing and industrial employment is significantly higher in PMD block groups than non-PMD block groups, even for areas that are heavily industrial. Blcok groups within PMDs, on average, have between six to eight times the manufacturing employment of non-covered block groups with at least one manufacturing job and around seven to eight times the amount of "industrial" employment. One way of visualizing this is looking at average manufacturing and industrial employment shares for PMD and non-PMD block groups over time.  
